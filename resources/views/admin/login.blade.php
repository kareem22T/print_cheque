...
<head>
    ...
    <title>Special Group | Print Cheque</title>
        ...
        <div class="d-flex align-items-center justify-content-center w-100">
            ...
            <div class="col-md-8 col-lg-6 col-xxl-3">
                ...
                <div class="card-body" id="login">
                    <h1 class="text-center">Special Group</h1>
                    <p class="text-center">Print Cheque | Dashboard</p>
                    <form @submit.prevent>
                    <div class="mb-3">
                        <label for="Username" class="form-label">Username</label>
                        <input type="text" class="form-control" id="Username" aria-describedby="emailHelp" v-model="email">
                    </div>
                    <div class="mb-4">
